...
use arrow::array::{StringArray, as_string_array, as_primitive_array};
...
fn test_deterministic_transform_pipeline() {
    ...
    assert!(qty_res.is_null(1), "Error de casteo debe resultar en null según kernel de Arrow");
