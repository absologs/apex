...
Este archivo establece las leyes fundamentales de termodinámica de software para este repositorio. Gemini CLI actuará como el garante determinista de estas reglas.

## 0. DIRECTIVAS DE INTERACCIÓN DEL AGENTE
...
## 1. INVARIANTES GLOBALES DE NÚCLEO
...
## 2. JURISDICCIÓN DE HERRAMIENTAS CLI
...
## 3. TERMODINÁMICA Y ARQUITECTURA
...
## 4. BUCLE DE VALIDACIÓN (EL ORÁCULO EMPÍRICO)
...
- **SÍNTESIS UI**: Cualquier mutación en `apex-ui` debe respetar la arquitectura basada en Tauri (HTML/Tailwind CSS + Vanilla JS) y el principio de "Inteligencia Aumentada, Carga Cero", compilando sin excepciones.